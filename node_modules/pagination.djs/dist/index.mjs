...
var _Pagination = class _Pagination extends PaginationEmbed {
  ...
  constructor(messageOrInteraction, options = {}) {
    ...
    if (!(messageOrInteraction instanceof BaseInteraction) && !(messageOrInteraction instanceof Message)) {
      console.warn(
        `[pagination.djs] warn - The interaction must be an instance of Interaction or Message, received + ${messageOrInteraction.construction.name}
  ...
  paginate(message) {
    this.collector = message.createMessageComponentCollector({
      filter: ({ customId, user }) => (
        ...
        ["first", "prev", "next", "last"].some((position) => this.buttons[position]?.data.custom_id === customId) && (this.authorizedUsers.length ? this.authorizedUsers.includes(user.id) : true)
      ),
      idle: this.idle,
